...
function setup() {
	...
	boxX= width/2
	boxY= 610
	boxleft= Bodies.rectangle (boxX - 120, boxY, 20, 100,{isStatic:true});
	World.add (world,boxleft);
	boxright= Bodies.rectangle (boxX + 100, boxY, 20, 100, {isStatic:true}); 
	World.add (world, boxright);
    boxbottom= Bodies.rectangle (boxX - 10, boxY + 45, 200, 20, {isStatic:true});
